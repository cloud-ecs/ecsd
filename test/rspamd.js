...
describe('rspamd', () => {
    ...
    describe('rspamc cli', () => {
        let avail;
        before(async () => { avail = await rspamd.binFound().catch(() => false); });
    ...
    describe('TCP', () => {
        let avail;
        before(async () => { avail = await rspamd.tcpListening().catch(() => false); });
    ...
    describe('unix socket', () => {
        let avail;
        before(async () => { avail = await rspamd.socketFound().catch(() => false); });
    ...
    describe.skip('scan dispatch', () => {
        let avail;
        before(async () => { avail = await rspamd.isAvailable().catch(() => false); });
